using OneTransfert.wasm.Shared;
using System.Diagnostics.CodeAnalysis;
using ZXingBlazor.Components;

namespace OneTransfert.wasm.Pages
{
    public partial class ScanCode : AppComponentBase
    {
        ...
        private void ScanResult(string e)
        {
            ...
            else
            {
                ...
                BarCode = $"{e}{Environment.NewLine}{BarCode}";
        ...
        private Task ScanResult2(string e)
        {
            ...
            BarCodesCustom = $"{e}{Environment.NewLine}{BarCodesCustom}";
            return Task.CompletedTask;
        }
